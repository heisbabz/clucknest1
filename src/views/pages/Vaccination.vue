  ...
  <v-app id="inspire">
    ...
    <v-main>
      <div class="row ma-4 mb-10">
        <div class="ma-2"><h3>Vaccination</h3></div>
        <v-spacer></v-spacer>
              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-select v-model="select" :items="breeds" :error-messages="selectErrors" label="Vaccine Type" required
...
export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Type', value: 'vaccine-type' },
        { text: 'Cost', value: 'vaccine-cost' },
        { text: 'Remarks', value: 'vaccine-remarks' },
        { text: 'Action'},
      ],
      // birds: [
      //   {
