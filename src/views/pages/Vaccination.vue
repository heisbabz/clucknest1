    ...
    <v-main>
        <div class="row ma-4 mb-10">
            ...
            <v-dialog v-model="dialog" persistent max-width="800px">
                ...
                <v-card>
                    <v-card-title>
                        <span class="headline">Vaccine</span>
                    </v-card-title>
                    <v-card-text>
                        <v-container>
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="6">
                                    <v-text-field label="Vaccination" hint="example of helper text only on focus"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                    <v-select v-model="select" :items="breeds" :error-messages="selectErrors" label="Vaccine Type" required @change="$v.select.$touch()" @blur="$v.select.$touch()">
                                    </v-select>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Cost of Vaccine" required type="number"></v-text-field>
                                </v-col>
